...
export const zh = {
  ...
  chat: {
    ...
    queuedDismissTip: "只把这条回执从 Meowo 移除,不撤回消息——CLI 队列里的它仍会在回合结束后执行。要真的撤掉,请到终端页操作。",
    interruptAndSendTip: "Ctrl+Enter:先中断当前回合,再发送这条消息;当前回合已完成的工作保留。直接按 Enter 则是排队,等这一回合结束后才处理。",
    interruptNow: "中断",
    interruptNowTip: "只发送中断键停止当前回合,不发送任何消息;已完成的工作保留。",
    ...
    sidebarNoDir: "未记录目录",
    sidebarGroup: "按目录分组",
    sidebarGroupTip: "把列表按工作目录折成分组;顺序不变——组仍按各自最靠前的会话排。",
    sidebarGroupOffTip: "取消分组,回到平铺列表。",
    running: "正在运行…",
  ...
  settings: {
    ...
    terminalGroup: "终端",
    terminalGroupDesc: "会话终端画面的显示样式，对已打开的终端即时生效",
    termFontSize: "终端字号",
