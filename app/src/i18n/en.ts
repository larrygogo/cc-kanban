...
export const en: Dict = {
  ...
  chat: {
    ...
    archiveTip: "Archive: hide this session from the board (this window keeps working)",
    unarchiveTip: "Unarchive: bring this session back to the board",
    ...
    queuedDismissTip: "Removes this receipt from Meowo only — it does not unsend anything. The CLI still has the message queued and will run it after the current turn. To actually drop it, use the Terminal tab.",
    interruptAndSendTip: "Ctrl+Enter: stop the current turn first, then send this message; completed work is kept. Plain Enter queues it until this turn ends.",
    interruptNow: "Interrupt",
    interruptNowTip: "Send only the interrupt key to stop the current turn; no message is sent. Completed work is kept.",
    ...
    sidebarGroup: "Group by folder",
    sidebarGroupTip: "Fold the list into folder groups. The order is unchanged — each group sits where its topmost session was.",
    sidebarGroupOffTip: "Turn grouping off and go back to a flat list.",
    running: "Running…",
  ...
  settings: {
    ...
    cardsGroup: "Cards",
    cardsGroupDesc: "How session cards on the board look and behave",
    updateTag: "Update",
    close: "Close",
    ...
    terminalGroupDesc: "How the session terminal is rendered; applies to open terminals instantly",
